...
export default function AuthCallback() {
    ...
    if (error) {
        return (
            <div className="min-h-screen bg-ds-bg text-ds-text selection:bg-white selection:text-black flex flex-col dot-grid items-center justify-center p-6">
                <div className="noise-overlay" />
                <div className="ds-panel max-w-sm w-full p-12 text-center animate-premium-fade-in border-ds-danger/20">
                    <div className="text-ds-danger text-[9px] font-black uppercase tracking-widest mb-6 opacity-60">System Fault</div>
                    <h2 className="text-2xl font-black text-white uppercase tracking-tight mb-4">Auth Failure</h2>
        ...
        <div className="min-h-screen bg-ds-bg text-ds-text selection:bg-white selection:text-black flex flex-col dot-grid items-center justify-center p-6">
            ...
            <div className="relative text-center animate-premium-fade-in space-y-8">
                ...
                <div className="space-y-2">
                    <h2 className="text-sm font-black text-white uppercase tracking-[0.4em]">Handshake in Progress</h2>
