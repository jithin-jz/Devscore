                ...
                <div className="relative text-center animate-premium-fade-in space-y-10">
                    ...
                    <div className="space-y-1">
                        ...
                        <p className="ds-label opacity-70">
                            Fetching your GitHub repositories and stats...
                        </p>
                    </div>
                </div>
            </div>
                                    ...
                                    <div className="ds-panel">
                                        ...
                                        <div className="space-y-2">
                                            <div className="flex justify-between">
                                                <span className="text-ds-muted/80 text-[9px] uppercase font-bold">
                                                    App Version
                                                </span>
                                            ...
                                            <div className="flex justify-between">
                                                ...
                                                <span className="ds-value uppercase">
                                                    {user?.id ? String(user.id).slice(0, 6) : 'N/A'}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <section className="ds-panel space-y-6">
                                ...
                                <div className="grid grid-cols-2 gap-4 py-6 border-y border-ds-border/30">
                                    <div className="text-center md:text-left">
                                        <span className="text-[8px] font-black uppercase tracking-[0.2em] text-ds-muted mb-1 block">
                                            Account Age
                                        </span>
                            ...
                            <section className="ds-panel space-y-6">
                                ...
                                <div className="p-4 md:p-5 rounded-lg bg-ds-accent/5 border border-ds-border flex flex-col md:flex-row items-center justify-between gap-4">
                                    <div className="space-y-1 text-center md:text-left">
                                        ...
                                        <p className="text-[10px] font-medium text-ds-muted max-w-xs capitalize">
                                            Current: {theme} mode
                                        </p>
                                    </div>
                                    ...
                                    {!showConfirmDelete ? (
                                        ...
                                        <div className="flex gap-2 w-full md:w-auto">
                                            <button
                                                ...
                                                className="flex-1 md:flex-none px-4 py-2 bg-ds-danger text-white text-[9px] font-black uppercase tracking-widest rounded shadow-lg shadow-ds-danger/20 hover:brightness-110 transition-all"
                                            >
                                                Confirm
                                            </button>
                                            <button
                                                onClick={() => setShowConfirmDelete(false)}
                                                className="flex-1 md:flex-none px-4 py-2 bg-ds-accent/5 text-ds-text text-[9px] font-black uppercase tracking-widest rounded border border-ds-border hover:bg-ds-accent/10 transition-all"
                                            >
                                                Cancel
                                            </button>
                                        </div>
